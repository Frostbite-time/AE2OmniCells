...
public class ModBlockTagProvider extends BlockTagsProvider
{
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider)
    {
        ...
        tag(AETags.FACADE_BLOCK_WHITELIST)
                .add(OCBlocks.CRAFTING_STORAGES.stream().map(RegistryObject::get).toArray(Block[]::new))
                .add(OCBlocks.CRAFTING_MONITORS.stream().map(RegistryObject::get).toArray(Block[]::new));
    }
}
