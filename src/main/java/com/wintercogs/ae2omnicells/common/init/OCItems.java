...
public class OCItems
{
    ...
    // ---- 非便携：全能存储元件（= 元件） ----
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_1K = registerCell("omni_cell_1k", 1, 63, 1);
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_4K = registerCell("omni_cell_4k", 2, 63, 4);
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_16K = registerCell("omni_cell_16k", 3, 63, 16);
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_64K = registerCell("omni_cell_64k", 4, 63, 64);
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_256K = registerCell("omni_cell_256k", 5, 63, 256);
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_1M = registerCell("omni_cell_1m", 6, 63, 1024);
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_4M = registerCell("omni_cell_4m", 7, 63, 4096);
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_16M = registerCell("omni_cell_16m", 8, 63, 16384);
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_64M = registerCell("omni_cell_64m", 9, 63, 65536);
    public static final RegistryObject<AEUniversalCellItem> OMNI_CELL_256M = registerCell("omni_cell_256m", 10, 63, 262144);
    ...
    // ---- 非便携：复杂存储元件（= 元件） ----
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_1K = registerComplexCell("complex_omni_cell_1k", 2, 12, 1);
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_4K = registerComplexCell("complex_omni_cell_4k", 4, 25, 4);
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_16K = registerComplexCell("complex_omni_cell_16k", 8, 50, 16);
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_64K = registerComplexCell("complex_omni_cell_64k", 16, 100, 64);
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_256K = registerComplexCell("complex_omni_cell_256k", 32, 200, 256);
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_1M = registerComplexCell("complex_omni_cell_1m", 64, 400, 1024);
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_4M = registerComplexCell("complex_omni_cell_4m", 128, 800, 4096);
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_16M = registerComplexCell("complex_omni_cell_16m", 256, 1600, 16384);
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_64M = registerComplexCell("complex_omni_cell_64m", 512, 3200, 65536);
    public static final RegistryObject<AEUniversalCellItem> COMPLEX_OMNI_CELL_256M = registerComplexCell("complex_omni_cell_256m", 1024, 6400, 262144);
    ...
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_1K = registerQuantumCell("quantum_omni_cell_1k", 3, -1, 1);
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_4K = registerQuantumCell("quantum_omni_cell_4k", 9, -1, 4);
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_16K = registerQuantumCell("quantum_omni_cell_16k", 27, -1, 16);
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_64K = registerQuantumCell("quantum_omni_cell_64k", 81, -1, 64);
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_256K = registerQuantumCell("quantum_omni_cell_256k", 243, -1, 256);
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_1M = registerQuantumCell("quantum_omni_cell_1m", 729, -1, 1024);
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_4M = registerQuantumCell("quantum_omni_cell_4m", 2187, -1, 4096);
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_16M = registerQuantumCell("quantum_omni_cell_16m", 6561, -1, 16384);
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_64M = registerQuantumCell("quantum_omni_cell_64m", 19683, -1, 65536);
    public static final RegistryObject<AEUniversalCellItem> QUANTUM_OMNI_CELL_256M = registerQuantumCell("quantum_omni_cell_256m", 59049, -1, 262144);
